...
track_length = path_gen.get_track_length(track_file)
...
v_max = rosparam.get_param("v_max")
...
if __name__ == "__main__":
    rospy.init_node('feasible_nmpc_node')
    ...
    csv_f = track_file
    time = 0
    global_path,x_spline,y_spline,time = path_gen.get_spline_path(csv_f,v_max)
    
    print(time)

    rate = rospy.Rate(100)
    vehicle_pose_msg = VehicleState()
    # N = 5
